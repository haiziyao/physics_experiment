...
light_c = {  # Ua= 16.0 25.0 36.0 49.0 64.0 81.0 100.0
    '0.600': [3,4, 4, 4, 4, 4, 5],  # 灯丝电流=0.600时的各Ua对应的Ia值
    '0.625': [7, 7, 7, 8, 8, 8, 9],  # 灯丝电流=0.625时的各Ua对应的Ia值
    '0.650': [13, 13, 14,15, 15, 16, 16],  # 灯丝电流=0.650时的各Ua对应的Ia值
    '0.675': [23, 25, 26, 27, 28, 29, 30],  # 灯丝电流=0.675时的各Ua对应的Ia值
    '0.700': [43, 45, 48, 50, 51, 53, 54],  # 灯丝电流=0.700时的各Ua对应的Ia值
    '0.725': [68, 72, 76, 79, 86, 89, 91],  # 灯丝电流=0.725时的各Ua对应的Ia值
    '0.750': [124, 131, 132, 137, 141, 151, 155]    # 灯丝电流=0.750时的各Ua对应的Ia值
}
